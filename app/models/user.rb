...
class User < ApplicationRecord
  ...
  validates :email, presence: true,
    format: { with: /\A[\w+\-.]+@[a-z\d\-.]+\z/i, message: "Invalid" },
    uniqueness: { case_sensitive: false, message: "Already taken" } # case_sensitive: false means that capitalized and non-capitalized will be considered as the same
end
